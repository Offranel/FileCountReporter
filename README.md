...
* Number of files by type (e.g., .txt, .jpg, .pdf)

The program also scans all subfolders.
...
* Display file types with counts
...
Add here the screenshot form to add a screenshot picture
